...
func registerAccountRoutes(admin *gin.RouterGroup, h *handler.Handlers) {
	accounts := admin.Group("/accounts")
	{
		...
		accounts.POST("/batch-probe-openai-special-429", h.Admin.Account.BatchProbeOpenAISpecial429)
		accounts.POST("/batch-enable-openai-special-429", h.Admin.Account.BatchEnableOpenAISpecial429)
		accounts.POST("/batch-disable-openai-special-429", h.Admin.Account.BatchDisableOpenAISpecial429)
