...
import {
  ...
  ensureRequiredTablePageSizeOptions,
...
describe('tablePreferences', () => {
  ...
  it('always keeps required page size options when normalizing arbitrary input', () => {
    expect(ensureRequiredTablePageSizeOptions([50, 1000, 10, 0, 1001])).toEqual([10, 20, 50, 100, 1000])
  })
})
