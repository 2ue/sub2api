  ...
  admin: {
    ...
    accounts: {
      ...
      bulkActions: {
        ...
        refreshToken: 'Refresh Token',
        probeOpenAISpecial429: 'Probe Weekly-Limited',
        disableOpenAISpecial429: 'Disable 429 Mode',
        resetStatusSuccess: 'Successfully reset {count} account(s) status',
        refreshTokenSuccess: 'Successfully refreshed {count} account(s) token',
        partialSuccess: 'Partially completed: {success} succeeded, {failed} failed',
        probeOpenAISpecial429Summary: 'Probe finished: {eligible} eligible, {callable} callable, {failed} failed, {skipped} skipped',
        probeOpenAISpecial429Running: 'Probing {count} account(s) in parallel',
        probeOpenAISpecial429RunningHint: 'This dialog stays open and each account result will be shown after probing finishes.',
        probeOpenAISpecial429ResultTitle: 'Probe Results',
        probeOpenAISpecial429Pending: 'Waiting for probe result...',
        probeOpenAISpecial429EnableHint: 'Only the {count} successfully probed account(s) will be enabled for special 429 mode and recovered.',
        probeOpenAISpecial429NoCallableDetail: 'No account was confirmed callable in this probe. You can close this dialog directly.',
        probeOpenAISpecial429CallableDefault: 'Callable',
        probeOpenAISpecial429FailedDefault: 'Probe failed',
        probeOpenAISpecial429UnknownResult: 'No probe result returned',
        probeOpenAISpecial429StatusPending: 'Probing',
        probeOpenAISpecial429StatusCallable: 'Callable',
        probeOpenAISpecial429StatusFailed: 'Failed',
        probeOpenAISpecial429StatusSkipped: 'Skipped',
        probeOpenAISpecial429SkipReasonNotFound: 'Account not found',
        probeOpenAISpecial429SkipReasonNotOpenAIOAuth: 'Not an OpenAI OAuth account',
        probeOpenAISpecial429SkipReasonAlreadyEnabled: 'Special 429 mode already enabled',
        probeOpenAISpecial429SkipReasonFiveHourLimited: 'Currently under 5-hour limit',
        probeOpenAISpecial429SkipReasonNotWeekLimited: 'No active weekly-limit state',
        enableOpenAISpecial429DialogTitle: 'Enable Special 429 Mode',
        enableOpenAISpecial429Action: 'Enable in Bulk',
        enableOpenAISpecial429Confirm: 'Enable special 429 mode and recover scheduling for these {count} account(s)?',
        enableOpenAISpecial429NoTarget: 'No OpenAI OAuth account can be enabled for special 429 mode',
        enableOpenAISpecial429ConcurrencyLabel: 'Concurrency',
        enableOpenAISpecial429ConcurrencyPlaceholder: 'Leave blank to keep current concurrency',
        enableOpenAISpecial429ConcurrencyHint: 'Optional. If set, the same concurrency will be applied while enabling special 429 mode.',
        enableOpenAISpecial429ConcurrencyInvalid: 'Concurrency must be an integer greater than 0',
        enableOpenAISpecial429Success: 'Enabled special 429 mode and recovered {count} account(s)',
        enableOpenAISpecial429Partial: 'Special 429 enable partially completed: {success} succeeded, {failed} failed',
        disableOpenAISpecial429Confirm: 'Disable special 429 mode for the selected {count} account(s)?',
        disableOpenAISpecial429NoTarget: 'No selected OpenAI OAuth account currently has special 429 mode enabled',
        disableOpenAISpecial429Success: 'Disabled special 429 mode for {count} account(s)',
        disableOpenAISpecial429Partial: 'Special 429 disable partially completed: {success} succeeded, {failed} failed'
      },
      bulkEdit: {
