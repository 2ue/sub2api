  ...
  admin: {
    ...
    accounts: {
      ...
      bulkActions: {
        ...
        resetStatus: '批量重置状态',
        refreshToken: '批量刷新令牌',
        probeOpenAISpecial429: '批量探测周限账号',
        disableOpenAISpecial429: '批量关闭 429 开关',
        resetStatusSuccess: '已成功重置 {count} 个账号状态',
        refreshTokenSuccess: '已成功刷新 {count} 个账号令牌',
        partialSuccess: '操作部分完成：{success} 成功，{failed} 失败',
        probeOpenAISpecial429Summary: '探测完成：候选 {eligible} 个，可调用 {callable} 个，失败 {failed} 个，跳过 {skipped} 个',
        probeOpenAISpecial429Running: '正在并发探测 {count} 个账号',
        probeOpenAISpecial429RunningHint: '弹层已打开，探测完成后会逐条显示每个账号的结果。',
        probeOpenAISpecial429ResultTitle: '探测结果',
        probeOpenAISpecial429Pending: '等待探测结果...',
        probeOpenAISpecial429EnableHint: '仅会对探测成功的 {count} 个账号开启 429 特殊模式并恢复调度。',
        probeOpenAISpecial429NoCallableDetail: '本次没有探测到可继续调用的账号，你可以直接关闭弹层。',
        probeOpenAISpecial429CallableDefault: '可继续调用',
        probeOpenAISpecial429FailedDefault: '探测失败',
        probeOpenAISpecial429UnknownResult: '未收到探测结果',
        probeOpenAISpecial429StatusPending: '探测中',
        probeOpenAISpecial429StatusCallable: '可调用',
        probeOpenAISpecial429StatusFailed: '失败',
        probeOpenAISpecial429StatusSkipped: '跳过',
        probeOpenAISpecial429SkipReasonNotFound: '账号不存在',
        probeOpenAISpecial429SkipReasonNotOpenAIOAuth: '不是 OpenAI OAuth 账号',
        probeOpenAISpecial429SkipReasonAlreadyEnabled: '已开启 429 特殊模式',
        probeOpenAISpecial429SkipReasonFiveHourLimited: '当前处于 5 小时限制',
        probeOpenAISpecial429SkipReasonNotWeekLimited: '当前没有周限状态',
        enableOpenAISpecial429DialogTitle: '批量开启 429 特殊模式',
        enableOpenAISpecial429Action: '批量开启',
        enableOpenAISpecial429Confirm: '是否对以上 {count} 个账号批量开启 429 特殊模式并恢复调度？',
        enableOpenAISpecial429NoTarget: '没有可开启 429 特殊模式的 OpenAI OAuth 账号',
        enableOpenAISpecial429ConcurrencyLabel: '并发数',
        enableOpenAISpecial429ConcurrencyPlaceholder: '留空则不修改并发',
        enableOpenAISpecial429ConcurrencyHint: '可选。填写后，会在批量开启时一并把这些账号的并发更新为同一个值。',
        enableOpenAISpecial429ConcurrencyInvalid: '并发数必须是大于 0 的整数',
        enableOpenAISpecial429Success: '已成功开启并恢复 {count} 个账号的 429 特殊模式',
        enableOpenAISpecial429Partial: '批量开启 429 特殊模式部分完成：成功 {success} 个，失败 {failed} 个',
        disableOpenAISpecial429Confirm: '确定要关闭选中 {count} 个账号的 429 特殊模式吗？',
        disableOpenAISpecial429NoTarget: '所选账号里没有已开启 429 特殊模式的 OpenAI OAuth 账号',
        disableOpenAISpecial429Success: '已成功关闭 {count} 个账号的 429 特殊模式',
        disableOpenAISpecial429Partial: '批量关闭 429 特殊模式部分完成：成功 {success} 个，失败 {failed} 个'
      },
      bulkEdit: {
        title: '批量编辑账号',
