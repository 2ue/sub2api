...
const buildOpenAIExtra = (base?: Record<string, unknown>): Record<string, unknown> | undefined => {
  ...
  if (accountCategory.value === 'oauth-based' && openAISpecialRateLimitEnabled.value) {
    extra.openai_oauth_special_rate_limit_enabled = true
    ...
    delete extra.openai_oauth_special_rate_limit_enabled
    delete extra.openai_oauth_special_429_temp_unsched_seconds
    delete extra.openai_oauth_special_429_escalation_window_seconds
    delete extra.openai_oauth_special_429_escalation_threshold
  }
